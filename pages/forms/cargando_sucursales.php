...
echo '<meta http-equiv="refresh" content="2;url=nuevas_sucursales.php">';
?>
<head>
    <meta charset="UTF-8">
            ...
            $(document).ready(function () {
                $('#add_item').click(function () {
                    var itemColumn = $('<tr id="items_' + indexItems + '" index="' + indexItems + '" class="items_colums" >'
                        ...
                        + '<td width="150px"><select class="form-control" id="suc_empresa_' + indexItems + '" item_id=""><?php include 'php/seleccion_empresas.php'?></select></td>'
