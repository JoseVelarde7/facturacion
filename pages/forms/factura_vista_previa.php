...
if(isset($_SESSION['num_conjun'])) {
$_SESSION['num_conjunta'] = 50;
    $numero_conjunta = $_SESSION['num_conjun'];
    //$numero_conjunta=59;
    // echo $numero_conjunta;
    include 'php/conexion_facturacion.php';
    $qa1 = pg_query("select count(id_factura) from public.factura_vista where numero_conjunta=" . $numero_conjunta . " ;");
    ...
    // echo  $_SESSION['cantidad_facturas']; 

    include 'php/conexion_facturacion.php';
    $qa1 = pg_query("select id_factura, id_cliente from public.factura_vista where numero_conjunta=" . $numero_conjunta . " ;");
//echo ("select id_factura, id_cliente from public.factura where numero_conjunta=".$numero_conjunta." ;");
    ...
    include 'php/conexion_facturacion.php';
    $qa1 = pg_query("select * from cliente_vista where id_cliente=" . $_SESSION["cliente"] . " ;");
    ...
    include 'php/conexion_facturacion.php';
    $qa1 = pg_query("select * from public.factura_vista a, public.dosificacion b, public.sucursal c 
...
//remember to sanitize user input in real-life solution !!!
    ...
    <div class="css-content_center">
        <h4 class="css-content_center">MOTOESCUELA DAKAR</h4>
    </div>
    ...
    <div class="css-content_center">
        <table class="css-info_table11">
            ...
            <tr>
                <td align="center" width="65"><FONT SIZE=1>SEÑOR (ES): </FONT></td>
...
FROM public.cantidad_articulos_factura_vista a, public.articulo b, public.precios_articulo c
        ...
        <table class="css-info_table1">
            ...
            while ($array = pg_fetch_assoc($qa10)) {
                ...
                echo '<tr><td align="left"><FONT SIZE=1><small>' . $descripcion . '</small></FONT></td>
                  ...
                  <td align="center"><FONT SIZE=1>' . $impotetotal . '</FONT></td></tr><tr><td><br></td></tr>';
            ...
            <table class="css-info_table2">
                ...
                <tr>
                    <td align="left"><FONT SIZE=1>
                            <small><?php echo numtoletras($totalpagar) ?></small>
                        </FONT></td>
                </tr>
                <tr>
                    <td align="left"><FONT
                ...
                <!-- <tr>
                    <td align="center"><FONT SIZE=1><i><?php echo(leyenda($_SESSION['leyenda_factura'])) ?></i></FONT>
                    </td>
                </tr> -->
                </tbody>
            </table>
...
//remember to sanitize user input in real-life solution !!!
                ...
                <tr>
                    ...
                    <td align="center"><FONT SIZE=1>
                            <small><?php echo number_format($totalpagar, 2, ',', '.') ?></small>
                        </FONT></td>
                </tr>
                <tbody>
            </table>
                ...
                <table class="css-info_table2">
                    ...
                    <tr>
                        <td align="center"><FONT
                                SIZE=1><i><?php echo(leyenda($_SESSION['leyenda_factura'])) ?></i></FONT></td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    <table class="css-info_table3">
        ...
        <tr>
            ...
            <td colspan="4" align="left"><FONT SIZE=1><b>
                        <small><?php echo numtoletras($totalfactura) ?></small>
                    </b></FONT></td>
        </tr>
    </table>
    <div class="css-content_center">
        ...
        <?php }?>
    <div class="css-content_center">
        <FONT SIZE=1><i>"ESTA FACTURA CONTRIBUYE AL DESARROLLO DE PAIS. EL USO ILICITO DE ESTA SERA SANCIONADO DE
                ACUERDO A
                LEY"</i></FONT>
    </div>
    </body>
...
function empresa($id_empresa){
    if($id_empresa==3){$empresa="EMPRESA PÚBLICA LÁCTEOS DE BOLIVIA";}
    if($id_empresa==2){$empresa="EMPRESA BOLIVIANA DE ALMENDRAS Y DERIVADOS";}
    if($id_empresa==1){$empresa="MOTOESCUELA DAKAR";}
