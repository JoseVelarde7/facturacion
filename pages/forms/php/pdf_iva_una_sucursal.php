...
$qa2 = pg_query("SELECT nombre_empresa, nombre_completo, nombre_sucursal, direccion_sucursal,nit_area, a.id_sucursal FROM public.dosificacion a, public.sucursal b, public.empresa c where b.id_empresa=c.id_empresa and a.id_sucursal=b.id_sucursal and b.id_empresa=" . $empresa_iva."and a.id_sucursal=".$_SESSION["sucursaliva"]);
