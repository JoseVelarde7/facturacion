    ...
    if (pg_num_rows($consulta) > 0) {
        ...
        if ($consulta) {
            ...
            while ($array = pg_fetch_assoc($consulta)) {
                ...
                $cantidad = cantidad1($array['id_articulo'], $_SESSION['sucursal_iva'], $_SESSION["fechainicial"], $_SESSION["fechafinal"]);


                if ($cantidad != 0) {
                    $precio = precio1($array['id_articulo'], $_SESSION['sucursal_iva'], $_SESSION["fechainicial"], $_SESSION["fechafinal"]);
