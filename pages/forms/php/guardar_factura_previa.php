...
include "conexion_facturacion.php";
$qa41 = pg_query("SELECT numero_conjunta FROM public.factura_vista WHERE id_factura=(select max(id_factura) from public.factura_vista) ");
...
$_SESSION['num_conjun']=$_SESSION['num_conjunta'];
...
include 'conexion_facturacion.php';
$qa4 = pg_query("SELECT id_cliente FROM public.cliente_vista WHERE nit_carnet='" . $_SESSION['array_nit'] . "' and cliente='" . $_SESSION['array_cliente'] . "';");
include 'desconectar_facturacion.php';
...
if (pg_num_rows($qa4) > 0) {
    ...
    include 'conexion_facturacion.php';
    $qa6 = pg_query("INSERT INTO public.cliente_vista(nit_carnet, cliente) VALUES ('" . $_SESSION['array_nit'] . "', '" . $_SESSION['array_cliente'] . "');");
//echo "INSERT INTO facturacion.cliente(nit_carnet, cliente) VALUES ('" . $_SESSION['array_nit'] . "', '" . $_SESSION['array_cliente'] . "');";
    $qa4 = pg_query("SELECT max(id_cliente) as id_cliente FROM public.cliente_vista WHERE nit_carnet='" . $_SESSION['array_nit'] . "';");
...
*/
        ...
        include 'conexion_facturacion.php';
        $qa3 = pg_query("INSERT INTO public.factura_vista(
...
*/
        include 'conexion_facturacion.php';
        $qa1 = pg_query("SELECT a.id_factura from public.factura_vista a, public.sucursal c where 
 c.id_sucursal=a.id_sucursal and a.id_factura=(select max(id_factura) from factura_vista where id_sucursal=" . $_SESSION['sucursal' . $i] . ") and c.id_sucursal=" . $_SESSION['sucursal' . $i]);
        include 'desconectar_facturacion.php';
        $row2 = pg_fetch_array($qa1);
        if (is_array($row2)) {
...
and b.id_articulo=" . $array_id_item[$j]);
            ...
            if (pg_num_rows($qa9) > 0) {
               // echo "entro";
                ...
                $qa3 = pg_query("INSERT INTO public.cantidad_articulos_factura_vista(
