...
if (isset($_REQUEST['data'])) {
    ...
    if (trim($_REQUEST['data']) == '')
      ...
      QRcode::png($_SESSION['nit_area'] . "|" . $_SESSION["numero_factura"] . "|" . $_SESSION["numero_autorizacion"] . "|" . $_SESSION['fecha_factura'] . "|" . $totalpagar . "|" . $totalpagar . "|" . trim($_SESSION['codigo_control']) . "|" . $_SESSION['nit_carnet'] . "|0|0|0|0.00", "codigo_qr.png", QR_ECLEVEL_L, 3, 3);
...
?>
   ...
   .css-info_table11 {
    ...
    <div class="css-content_center">
        <h4 class="css-content_center">Empresa Boliviana de Alimentos y Derivados</h4>
    </div>
    ...
    <?php }else{?>
        <div class="css-content_center">
            <h4 class="css-content_center">FACTURA</h4>
        </div>
<?php }?>
    <div class="css-content_center">
...
<?php
    ...
    <div class="css-content_center">
        <table class="css-info_table11">
            ...
            <tr>
                <td align="center" width="65"><FONT SIZE=1>SE&Ntilde;OR (ES): </FONT></td>
            ...
            <table class="css-info_table2">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td align="center"><img src="codigo_qr.png" /></td>
...
function leyenda($leyenda)
{
  ...
  if ($leyenda == 18) {
        $ley = "Ley NÂ° 453: Los servicios deben suministrarse en condiciones de inocuidad, calidad y seguridad.";
    }
    return $ley;
}
