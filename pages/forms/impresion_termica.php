...
if (isset($_REQUEST['data'])) {
    ...
    if (trim($_REQUEST['data']) == '')
      ...
      QRcode::png($_SESSION['nit_area'] . "|" . $_SESSION["numero_factura"] . "|" . $_SESSION["numero_autorizacion"] . "|" . $_SESSION['fecha_factura'] . "|" . $totalpagar . "|" . $totalpagar . "|" . trim($_SESSION['codigo_control']) . "|" . $_SESSION['nit_carnet'] . "|0|0|0|0.00", "codigo_qr.png", 'L', 3, 3);
