                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select name="id_empresa"
                                                    class="form-control"><?php include 'php/seleccion_empresas.php' ?></select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="body table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        <thead>
                                            <tr class="bg-teal">
                                            <th align="center">#</th>
                                            <th align="center">DESCRIPCION DE ARTICULO</th>
                                            <th align="center">UNIDAD DE MEDIDA</th>
                                            <th align="center">TIPO DE PRESENT.</th>
                                            <th align="center">CANTIDAD INGRE.</th>
                                            <th align="center"> BAJA</th>
                                ...
                                <tfoot>
                                    ...
                                    <th align="center">#</th>
                                        ...
                                        <tbody>
                                        <?php include "php/tabla_gestion_productos.php";
                                        ?>
                                        </tbody>
                                    </table>
                                </div>
