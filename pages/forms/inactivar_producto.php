...
if (is_array($row)) {
    $articulo = $row['descripcion_articulo']." Medida:".$row['unidad_medida'] ." Codigo:".$row['codigo_articulo'];
}
?>
<!-- Page Loader -->
...
<section class="content">
    <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="sign_in" method="POST">
                            <?php
                            echo '<div class="alert alert-danger">Esta seguro de inactivar el producto ' . strtoupper($articulo).'
                               </div>';
        ...
        if (isset($_POST['confirma'])) {
            include "php/conexion_facturacion.php";
            $qa = pg_query("UPDATE public.articulo SET estado_articulo=FALSE WHERE id_articulo=" .$id_producto. ";");
  ...
  <strong>LA SUCURSAL FUE DESACTIVADA CON EXITO</strong> 
            ...
            ECHO '<meta http-equiv="Refresh" content="1;url=gestionar_productos.php">';
        }
