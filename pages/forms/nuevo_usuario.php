                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST">
                            <?php
                            include "php/guardar_registro_usuario.php";
                            ?>
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <input type="radio" name="sexo" id="male" class="with-gap radio-col-teal"
                                               value="M" checked>
                                        <label for="male">Masculino</label>

                                        <input type="radio" name="sexo" id="female" class="with-gap radio-col-teal"
                                               value="F">
                            ...
                            <div class="row clearfix">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="usuario"
                                                  required>
                                            <label class="form-label">Usuario (Ingreso al sistema)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="password" class="form-control" name="clave"
                                                   style="text-transform: uppercase" required>
                                            <label class="form-label">Contraseña (Ingreso al sistema)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group form-float" >
                                            <div class="form-line">
                                                <select class="form-control" name="id_area" readOnly="true"><?php  include "php/seleccion_areas.php" ?><select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group form-float" >
                                            <div class="form-line">
                                                <select class="form-control" name="id_rol"><?php  include "php/seleccion_roles_usuario.php"?><select>
                            ...
                            <button type="submit" class="btn btn-info waves-effect" name="guardar">GUARDAR DATOS</button>
