       ...
       <?php
        ...
        <?php include "pie_pagina.php";
         include "php/conexion_facturacion.php";
                                  $consulta = pg_query("select * from sucursal a, empresa b where a.id_empresa=b.id_empresa order by a.id_empresa");
...
<section class="content">
  ...
  <div class="body">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header bg-blue-grey">
                        <h2>
                            <i class="glyphicon glyphicon-th-list"></i>  EDICION DE DATOS DE LAS SUCURSALES
                        </h2>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                            ...
                                            while($array = pg_fetch_array($consulta)) {
                                                ...
                                                <tr>
                                                    <td><?php echo $cont;?></td>
                                                    <td><?php echo  strtoupper($array['direccion_sucursal'])?></td>
                                                    <td><?php echo strtoupper($array['nombre_sucursal']);?></td>
                                                     <td><?php echo strtoupper($array['telefono']); ?></td>
                                                    <td align="center"><?php echo verda($array['estado']);?></td>
                                                    <td align="center"><?php echo asignado($array['situacion']) ;?></td>
                                                    <td align="center"><?php echo strtoupper($array['nombre_empresa']);?></td>
                                                    <td align="center"><?php echo anul($array['estado'],$array['id_sucursal']) ;?></td>
                                                     <td align="center"><?php echo '<a class="btn btn-sm btn-primary" href="modificar_sucursal.php?id_suc=' . $array['id_sucursal'] . '" target=""><i class="glyphicon glyphicon-pencil"></i></a>';?></td>
        ...
        <?php
        function asignado($estado)
        {
            if($estado=='f'){$veren= '<span class="label bg-red">Si</span>';}
            else{$veren= '<span class="label bg-green">No</span>';}
        ...
        function anul($anulado,$id)
        {
            if($anulado=='t'){
                $anu = '<a class="btn btn-warning waves-effect"'.
                    ' href="inactivar_sucursal.php?id_suc='.$id.
                    '"target="">'.
