...
include "php/seleccionar_datos_sucursal.php" ?>
<section>
...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                FORMULARIO DE MODIFICACION DE DATOS DE LAS SUCURSALES
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>INGRESE LOS DATOS A MODIFICAR DE LA SUCURSAL</h2>
                    </div>
                    <div class="body">
                        <form id="form_validation" method="POST">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            ...
                                            <label class="form-label">Direccion de Sucursal</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            ...
                                            <label class="form-label">Hubicacion de Sucursal</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            <input type="text" class="form-control" name="nombre" value="<?php echo $nombre ?>"
                                                   style="text-transform: uppercase" required>
                                            <label class="form-label">Nombre_sucursal</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line focused">
                                            <input type="text" class="form-control" value="<?php echo $empresa ?>"
                                                   name="empresa">
                                ...
                                <div class="col-sm-6">
                                    <b>Estado de sucursal</b>
                                    <div class="input-group">

                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="form-control"
                                                        name="estado"><?php include "php/seleccion_estado_sucursal.php" ?>
                                                    <select>
                                ...
                                <div class="col-sm-6">
                                    <b>Situacion de la Sucursal</b>
                                    <div class="input-group">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="form-control"
                                                        name="situacion"><?php include "php/seleccion_situacion_sucursal.php" ?>
                                                    <select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php
                                ...
                                include "php/guardar_modificacion_sucursal.php";
